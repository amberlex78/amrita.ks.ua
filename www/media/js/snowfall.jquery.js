	...
	$.snowfall = function(element, options){
		...
		function Flake(_x, _y, _size, _speed, _id){
			...
			if(1){
				...
				tmp = random(1,2);
				if(tmp == 1){
					flakeMarkup[0].src = '/media/img/snow1.png';
					this.size = 14;
				}else if(tmp == 2){
					flakeMarkup[0].src = '/media/img/snow2.png';
					this.size = 28;
				}
			}else{
		...
		$(window).bind("resize", function(){
			elHeight = $(element)[0].clientHeight-100;
			elWidth = $(element)[0].offsetWidth-20;
