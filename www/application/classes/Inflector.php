...
class Inflector extends Kohana_Inflector
{
	...
	/**
	 * Преобразование camelCasedWord в camel_cased_word
	 *
	 * @param $camelCasedWord
	 *
	 * @return string
	 */
	public static function underscore_camelcased($camelCasedWord)
	{
	 ...
	 *     echo $num . '  ' . Inflector::num_2_word($num, $words); // сколько новостей
	 *
	 * @param   $n
	 * @param   $words
	 *
	 ...
	 */
	public static function num_2_word($n, $words)
	{
