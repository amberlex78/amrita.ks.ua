...
<ul class="pagination pagination-right">
	<?php if ($previous_page !== FALSE): ?>
		<li><a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?php echo __('app.pg_previous') ?></a></li>
	<?php else: ?>
		<li class="active"><a href="#"><?php echo __('app.pg_previous') ?></a></li>
	<?php endif ?>
	...
	<?php if ($next_page !== FALSE): ?>
		<li><a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next"><?php echo __('app.pg_next') ?></a></li>
	<?php else: ?>
		<li class="active"><a href="#"><?php echo __('app.pg_next') ?></a></li>
	<?php endif ?>
</ul>
