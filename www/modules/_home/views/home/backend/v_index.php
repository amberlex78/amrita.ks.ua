...
echo TB_Form::horizontal_open('');
	...
	echo TB_Form::control_group(
		Form::label('text', __('home.page_text')),
	...
	echo TB_Form::control_group_with_error(
		...
		TB_Form::block_help(__('home.meta_t_h'))
	);
	...
	echo TB_Form::control_group_with_error(
		...
		TB_Form::block_help(__('home.meta_d_h').'<br><div id="chars_meta_d"></div>')
	);
	...
	echo TB_Form::control_group_with_error(
		...
		TB_Form::block_help(__('home.meta_k_h').'<br><div id="chars_meta_k"></div>')
	);
